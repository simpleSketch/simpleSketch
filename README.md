...
1) Download the latest release of simpleSketch from [our website](https://sites.google.com/view/simplesketch/download), or if you would like to use an older version, take a look at [all of the versions](https://sites.google.com/view/simplesketch/download/all-versions).
2) Unzip the files.
